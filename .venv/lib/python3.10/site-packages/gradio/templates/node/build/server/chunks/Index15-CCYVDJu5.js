...
import { B as Block, S as Static, f as BlockLabel, Q as Code$2, h as Empty, j as IconButton, z as Copy$1, D as DownloadLink, k as Download$1, i as IconButtonWrapper, V as getWorkerProxyContext } from './2-CVUfZn_M.js';
...
const lang_map = {
  python: () => import('./index32-DGMvpkG1.js').then((m) => m.python()),
  ...
  markdown: async () => {
    const [md, frontmatter] = await Promise.all([
      import('./index33-Dmpf_yM5.js'),
      import('./frontmatter-BG3Hl7m5.js')
    ]);
  ...
  json: () => import('./index37-BBeMGyKF.js').then((m) => m.json()),
  html: () => import('./index34-DMAEcd18.js').then((m) => m.html()),
  css: () => import('./index35-By49dThg.js').then((m) => m.css()),
  javascript: () => import('./index36-BaGQw85s.js').then((m) => m.javascript()),
  jinja2: () => import('./jinja2-BxhAu_54.js').then(
    (m) => StreamLanguage.define(m.jinja2)
  ),
  typescript: () => import('./index36-BaGQw85s.js').then(
...
//# sourceMappingURL=Index15-CCYVDJu5.js.map

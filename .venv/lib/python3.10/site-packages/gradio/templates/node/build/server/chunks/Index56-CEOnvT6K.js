...
import { B as Block, S as Static, f as BlockLabel, y as File$1, h as Empty, U as UploadText, i as IconButtonWrapper, j as IconButton, J as Undo, k as Download } from './2-CVUfZn_M.js';
import { U as Upload, M as ModifyUpload } from './ModifyUpload-BzKPE7XY.js';
...
async function loadCanvas3D$1() {
  const module = await import('./Canvas3D-Bx9cVrOG.js');
  return module.default;
}
async function loadCanvas3DGS$1() {
  const module = await import('./Canvas3DGS-BGPUVZIn.js');
  return module.default;
}
...
//# sourceMappingURL=Index56-CEOnvT6K.js.map
